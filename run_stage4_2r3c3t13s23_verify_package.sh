...
PYTHON_BIN="${STAGE4_2R3C3T13S23_PYTHON:-/home/yangshen0711/tsc_all/tsc_simulation/venv_simu/bin/python}"
[[ -x "${PYTHON_BIN}" ]] || {
...
expected = {
    ...
    "run_name": "stage4_2r3c3t13s23_sequential_hadamard_lattice_preflight",
    "campaign_identity": "sequential_four_knot_hadamard_card15_lattice_preflight_v1",
    "package_revision": "r42r3c3t13s23_sequential_hadamard_lattice_preflight_v1",
}
...
cfg = json.loads(
    (root / "configs/stage4_2r3c3t13s23_sequential_hadamard_lattice_preflight_v1.json").read_text(
        encoding="utf-8"
    )
)
s23._validate_design(cfg)
print("[T13S23 verify] Python/JSON/scientific guards passed.")
PY
...
"${PYTHON_BIN}" -m unittest -v \
  tests.test_stage4_2r3c3t13s23_sequential_hadamard_lattice_preflight
printf '[T13S23 verify] checksums, shell syntax and focused tests passed.\n'
