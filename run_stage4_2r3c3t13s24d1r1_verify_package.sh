...
python_bin="${STAGE4_2R3C3T13S24D1R1_PYTHON:-/home/yangshen0711/tsc_all/tsc_simulation/venv_simu/bin/python}"
"${python_bin}" - <<'PY'
import json
...
print("[T13S24D1R1 verify] JSON parse passed")
PY
...
"${python_bin}" -m py_compile \
  ...
  tests/test_stage4_2r3c3t13s24d1r1_geometry_restoring_amplitude_search.py
...
printf '[T13S24D1R1 verify] checksums, shell syntax, compile, JSON and focused tests passed.\n'
