...
PYTHON_BIN="${STAGE4_2R3C3T10_PYTHON:-${PYTHON:-python3}}"
cd "${PROJECT_DIR}"
...
expected = {
    ...
    "controller_revision": "no_controller_offline_interpolant_v1",
    "package_revision": "r42r3c3t10_interaction_aware_feasibility_v1",
    "run_name": "stage4_2r3c3t10_interaction_aware_feasibility",
}
...
from tests import test_stage4_2r3c3t10_interaction_aware_feasibility as test_t10

test_t10.T10._validate_design(test_t10.Stage42R3C3T10Tests.config if hasattr(test_t10.Stage42R3C3T10Tests, "config") else json.loads((root / "configs/stage4_2r3c3t10_interaction_aware_feasibility_v1.json").read_text(encoding="utf-8")))
print("[Stage4.2R3c3T10 verify] Python/JSON/scientific guards passed.")
PY
...
printf '[Stage4.2R3c3T10 verify] checksums, shell syntax and focused tests passed.\n'
