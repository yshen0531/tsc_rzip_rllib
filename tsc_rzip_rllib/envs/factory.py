...
def env_kwargs_from_train_config(train_cfg: dict[str, Any], worker_id: str) -> dict[str, Any]:
    ...
    return dict(
        ...
        w_soft_rz_distance=rew.get("w_soft_rz_distance", 0.0),
        soft_rz_r_tol_m=rew.get("soft_rz_r_tol_m", 0.08),
        soft_rz_z_tol_m=rew.get("soft_rz_z_tol_m", 0.08),
        soft_rz_distance_clip=rew.get("soft_rz_distance_clip", 6.0),
        soft_rz_phase_floor=rew.get("soft_rz_phase_floor", 0.25),
        w_soft_rz_progress=rew.get("w_soft_rz_progress", 0.0),
        soft_rz_progress_ref=rew.get("soft_rz_progress_ref", 0.10),
        soft_rz_progress_clip=rew.get("soft_rz_progress_clip", 1.5),
        w_soft_rz_outward_velocity=rew.get("w_soft_rz_outward_velocity", 0.0),
        w_soft_rz_near_velocity=rew.get("w_soft_rz_near_velocity", 0.0),
        soft_rz_velocity_sigma=rew.get("soft_rz_velocity_sigma", 3.0),
        soft_rz_velocity_ref_m_per_s=rew.get("soft_rz_velocity_ref_m_per_s", 1.0),
