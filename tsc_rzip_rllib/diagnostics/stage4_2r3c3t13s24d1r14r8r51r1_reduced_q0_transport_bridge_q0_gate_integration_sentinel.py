#!/usr/bin/env python3
"""Execute the frozen R8R51R1 q0-to-transport causal bridge sentinel."""
...
IDENTITY = "reduced_q0_transport_bridge_q0_gate_integration_sentinel_v1"
RUN_NAME = "stage4_2r3c3t13s24d1r14r8r51r1_reduced_q0_transport_bridge_q0_gate_integration_sentinel"
CONTROLLER_REVISION = "reduced_q0_transport_bridge_q0_gate_integration_v42r3c3t13s24d1r14r8r51r1_v1"
SELECTED_CANDIDATE_IDS = (
    "d0m", "d0p", "d1p", "d2m", "d3m", "d3p",
    "u1p00", "u1p25", "u1p50", "v0p75", "v1p00", "v1p25", "v1p50",
)
N_COILS = 14
PREFIX_END = 10
Q0_STEP = 10
...
def validate_config(cfg: Mapping[str, Any], *, project_root: Path) -> None:
    ...
    r8r51_source = project_root / str(cfg.get("source_r8r51_config", ""))
    source = project_root / str(cfg.get("source_r8r48_config", ""))
    r8r49_source = project_root / str(cfg.get("source_r8r49_config", ""))
    source_contract = cfg.get("source_r8r48", {})
    r8r49_contract = cfg.get("source_r8r49", {})
    r8r51_contract = cfg.get("source_r8r51", {})
    source_hash_keys = (
    ...
    r8r49_hash_keys = (
        "offline_primary_sha256", "offline_independent_sha256",
        "offline_construction_sha256", "all_specs_sha256",
        "source_authentication_sha256", "stage_state_sha256",
        "stage_manifest_sha256",
    )
    r8r51_hash_keys = (
        "raw_inventory_digest", "raw_primary_sha256", "raw_independent_sha256",
        "partial_prefix_forensics_sha256", "failure_compact_audit_sha256",
        "failure_final_report_sha256", "all_specs_sha256",
        "source_authentication_sha256", "stage_state_sha256",
        "stage_manifest_sha256", "implementation_sha256",
    )
    ...
    expected_ids = ("q0",) + SELECTED_CANDIDATE_IDS
    expected_r8r49_contract = {
        "stage_directory": "stage4_2r3c3t13s24d1r14r8r49_q0_to_transport_causal_bridge_identification_sentinel",
        "required_route": "Q0_TO_TRANSPORT_BRIDGE_SENTINEL_OFFLINE_FAIL_NO_REAL_TSC",
        "offline_primary_sha256": "8258e0369de1b79814efec2e3ec85bd843e37bc387b0d21fa4996e32de68d655",
        "offline_independent_sha256": "d1dec48db8e915d673d2db7a4b5ea95ed316ba838cdc404cbbb2a1ad91c302f9",
        "offline_construction_sha256": "fd112e5fdb1527059003cccf5bd2219e6f0fd175306aafe8edf71a4073a41002",
        "all_specs_sha256": "fb4164bbe109a0994f5fd7c163d19e788be093d8b69e0adc37bbc5389f6f4afc",
        "source_authentication_sha256": "75aeb74cbc70e4bc392dd9b1250c41d2768274bf7845252f7b020c8bcbf6aa9b",
        "stage_state_sha256": "8afbfec8f9ba33cf7763cef8fe7bd06425f5a06890309892f9de251b97790962",
        "stage_manifest_sha256": "a71349895dc20e17fb529bb1842f07d45bf6d1737a072e40420cc1bf90484044",
    }
    expected_r8r51_contract = {
        "stage_directory": "stage4_2r3c3t13s24d1r14r8r51_reduced_q0_transport_bridge_identification_sentinel",
        "required_route": "REDUCED_Q0_TRANSPORT_BRIDGE_SENTINEL_IMPLEMENTATION_GATE_FAIL_NEW_IDENTITY_REQUIRED",
        "raw_count": 208,
        "raw_bytes": 5155700,
        "raw_inventory_digest": "ea6ba731534adc810adac98172971aed031a42355ac8c443a3aceab6831751dd",
        "raw_primary_sha256": "330c572182048cc3360b9061a153ab995b508263d45de666ffcf3bb76d9f0b55",
        "raw_independent_sha256": "0468f446ed8cfb3a21e985c0006e2293bfbb218892458107f37513d49e8b6472",
        "partial_prefix_forensics_sha256": "daf7018de334fe0f7ee5bae561d4f26df02de569033ffe953526244d43ead414",
        "failure_compact_audit_sha256": "e376c5b4c1f1e8654d8dd5fd985d55a3efad0de64139e65c48c5c97a11f0a086",
        "failure_final_report_sha256": "41b2c79591c3a4dafe522dad994a14ddcc3b0cb5395bbe01afab747044dc8d2c",
        "all_specs_sha256": "dc73c68c1181fd162dcf819712f124145b9fb005a9fa6d2ea55d36cb14b1a108",
        "source_authentication_sha256": "8d1b819e89cb5459b967a18d585175eb17cdc310c91a5018fc072071cb414c0b",
        "stage_state_sha256": "1307d2f8cda12ae43c1beffa4f088640bf21025ef24720b7356ba43097d7dcae",
        "stage_manifest_sha256": "80eeec45e7816d97d635dec070f0e3eef4199443be84a95885a2e1c49a2dd994",
        "implementation_sha256": "4a936b7577585d5dc5ee66f9a4a35f93bd043c6198ba66b016983c1eac62be0a",
    }
    expected_routes = {
        "source_blocked": "REDUCED_Q0_TRANSPORT_BRIDGE_Q0_GATE_INTEGRATION_BLOCKED_BY_SOURCE",
        "offline_fail": "REDUCED_Q0_TRANSPORT_BRIDGE_Q0_GATE_INTEGRATION_OFFLINE_FAIL_NO_REAL_TSC",
        "execution_fail": "REDUCED_Q0_TRANSPORT_BRIDGE_Q0_GATE_INTEGRATION_EXECUTION_FAIL_STOP",
        "safety_fail": "REDUCED_Q0_TRANSPORT_BRIDGE_Q0_GATE_INTEGRATION_SAFETY_FAIL_REDESIGN",
        "pass": "REDUCED_Q0_TRANSPORT_BRIDGE_Q0_GATE_INTEGRATION_COMPLETE_R51R2_MODEL_PREFLIGHT_REQUIRED",
    }
    invalid = (
        ...
        != "r42r3c3t13s24d1r14r8r51r1_q0_gate_integration_v1"
        or not design.is_file()
        or _sha(design) != cfg.get("design_document_sha256")
        or not r8r51_source.is_file()
        or _sha(r8r51_source) != cfg.get("source_r8r51_config_sha256")
        or not source.is_file()
        or _sha(source) != cfg.get("source_r8r48_config_sha256")
        or not r8r49_source.is_file()
        or _sha(r8r49_source) != cfg.get("source_r8r49_config_sha256")
        ...
        or r8r49_contract != expected_r8r49_contract
        or any(
            not isinstance(r8r49_contract.get(key), str)
            or len(r8r49_contract[key]) != 64
            or any(character not in "0123456789abcdef" for character in r8r49_contract[key])
            for key in r8r49_hash_keys
        )
        or r8r51_contract != expected_r8r51_contract
        or any(
            not isinstance(r8r51_contract.get(key), str)
            or len(r8r51_contract[key]) != 64
            or any(character not in "0123456789abcdef" for character in r8r51_contract[key])
            for key in r8r51_hash_keys
        )
        ...
        or matrix.get("selected_q_float64_le_c_sha256")
        != "5d6b6c20a704eceda43db7cbaece445d1655a4d62da16d185b308bc27ed4b674"
        or matrix.get("selected_requested_float64_le_c_sha256")
        != "82e26d01b53fc8bb986ab5a127f8400bc10dcd823a879450ab54275fc2e50543"
        or int(matrix.get("selected_q_rank", -1)) != 4
        or float(matrix.get("selected_q_condition", -1.0)) != 1.7853571071357124
        ...
        or any(controller.get(key) is not True for key in (
            ...
            "safe_stop_before_failed_advance", "require_shared_q0_constructor_parity",
            "forbid_q0_zero_target_predicate",
        ))
    ...
    if invalid:
        raise ValueError("R8R51R1 frozen design changed")
...
def load_context(args: argparse.Namespace) -> Context:
    ...
    return Context(
        ...
        r8r49_stage=(args.r8r49_run.expanduser().resolve() / str(cfg["source_r8r49"]["stage_directory"])),
        r8r51_stage=(args.r8r51_run.expanduser().resolve() / str(cfg["source_r8r51"]["stage_directory"])),
        r8r22_ctx=r8r22_ctx,
...
def _source_baselines(ctx: Context) -> tuple[list[dict[str, Any]], dict[str, dict[str, Any]]]:
    ...
    if len(specs) != 16 or len(results) != 16:
        raise SourceBlockedError("R8R51R1 source baseline coverage changed")
...
def _r8r51_paths(stage: Path) -> dict[str, Path]:
    return {
        "raw_primary": stage / "analysis/raw_primary.json",
        "raw_independent": stage / "analysis/raw_independent.json",
        "partial_prefix_forensics": stage / "analysis/partial_prefix_forensics.json",
        "failure_compact_audit": stage / "analysis/failure_compact_audit.json",
        "failure_final_report": stage / "analysis/failure_final_report.json",
        "all_specs": stage / "specs/all_specs.json",
        "source_authentication": stage / "source_reference/source_authentication.json",
        "stage_state": stage / "stage_state.json",
        "stage_manifest": stage / "stage_manifest.json",
...
def authenticate_sources(ctx: Context) -> dict[str, Any]:
    r8r51_paths = _r8r51_paths(ctx.r8r51_stage)
    r8r51_contract = ctx.cfg["source_r8r51"]
    if any(not path.is_file() for path in r8r51_paths.values()):
        raise SourceBlockedError("R8R51R1 final R8R51 evidence incomplete")
    r8r51_hashes = {name: _sha(path) for name, path in r8r51_paths.items()}
    if any(r8r51_hashes[name] != r8r51_contract[f"{name}_sha256"] for name in r8r51_hashes):
        raise SourceBlockedError("R8R51R1 final R8R51 hash changed")
    r8r51_source = _root() / "tsc_rzip_rllib/diagnostics/stage4_2r3c3t13s24d1r14r8r51_reduced_q0_transport_bridge_identification_sentinel.py"
    if _sha(r8r51_source) != r8r51_contract["implementation_sha256"]:
        raise SourceBlockedError("R8R51R1 R8R51 implementation hash changed")
    r8r51_primary = _read(r8r51_paths["raw_primary"])
    r8r51_independent = _read(r8r51_paths["raw_independent"])
    r8r51_partial = _read(r8r51_paths["partial_prefix_forensics"])
    r8r51_compact = _read(r8r51_paths["failure_compact_audit"])
    r8r51_final = _read(r8r51_paths["failure_final_report"])
    r8r51_state = _read(r8r51_paths["stage_state"])
    inventory = r8r51_primary.get("raw_inventory") or {}
    if (
        r8r51_primary.get("route") != "REDUCED_Q0_TRANSPORT_BRIDGE_SENTINEL_SAFETY_FAIL_REDESIGN"
        or r8r51_primary.get("passed") is not False
        or r8r51_independent.get("primary_agreement") is not True
        or r8r51_independent.get("primary_route_agreement") is not True
        or r8r51_partial.get("passed") is not True
        or r8r51_partial.get("route") != r8r51_contract["required_route"]
        or r8r51_partial.get("raw_proves_response_outcomes_opened") is not False
        or r8r51_compact.get("route") != r8r51_contract["required_route"]
        or r8r51_compact.get("forensics_passed") is not True
        or r8r51_compact.get("stage_passed") is not False
        or r8r51_final.get("route") != r8r51_contract["required_route"]
        or r8r51_final.get("forensics_passed") is not True
        or r8r51_final.get("passed") is not False
        or r8r51_state.get("phase_status") != "real_execution_failed"
        or r8r51_state.get("finished") is not True
        or r8r51_state.get("real_tsc_executed") is not True
        or int(inventory.get("count", -1)) != r8r51_contract["raw_count"]
        or int(inventory.get("bytes", -1)) != r8r51_contract["raw_bytes"]
        or inventory.get("digest") != r8r51_contract["raw_inventory_digest"]
        or int(r8r51_partial.get("counts", {}).get("q0_action_not_applied", -1)) != 208
        or int(r8r51_partial.get("counts", {}).get("candidate_not_constructed", -1)) != 208
        or r8r51_partial.get("criterion_false_counts") != {"q0_zero_target": 208}
    ):
        raise SourceBlockedError("R8R51R1 final R8R51 route changed")
    paths = _r8r48_paths(ctx.r8r48_stage)
    contract = ctx.cfg["source_r8r48"]
    if any(not path.is_file() for path in paths.values()):
        raise SourceBlockedError("R8R51R1 final R8R48 evidence incomplete")
    hashes = {name: _sha(path) for name, path in paths.items()}
    if any(hashes[name] != contract[f"{name}_sha256"] for name in hashes):
        raise SourceBlockedError("R8R51R1 final R8R48 hash changed")
    ...
    if (
        ...
        raise SourceBlockedError("R8R51R1 final R8R48 route changed")
    r8r49_paths = _r8r49_paths(ctx.r8r49_stage)
    r8r49_contract = ctx.cfg["source_r8r49"]
    if any(not path.is_file() for path in r8r49_paths.values()):
        raise SourceBlockedError("R8R51R1 final R8R49 evidence incomplete")
    r8r49_hashes = {name: _sha(path) for name, path in r8r49_paths.items()}
    if any(r8r49_hashes[name] != r8r49_contract[f"{name}_sha256"] for name in r8r49_hashes):
        raise SourceBlockedError("R8R51R1 final R8R49 hash changed")
    r8r49_primary = _read(r8r49_paths["offline_primary"])
    r8r49_independent = _read(r8r49_paths["offline_independent"])
    r8r49_state = _read(r8r49_paths["stage_state"])
    r8r49_construction = _read(r8r49_paths["offline_construction"])
    r8r49_rows = list(r8r49_construction.get("rows", ()))
    selected_development_rows = [
        row for row in r8r49_rows if row.get("candidate_id") in SELECTED_CANDIDATE_IDS
    ]
    excluded_development_rows = [
        row for row in r8r49_rows if row.get("candidate_id") not in SELECTED_CANDIDATE_IDS
    ]
    if (
        r8r49_primary.get("route") != r8r49_contract["required_route"]
        or r8r49_primary.get("passed") is not False
        or int(r8r49_primary.get("construction_count", -1)) != 256
        or int(r8r49_primary.get("construction_pass_count", -1)) != 208
        or r8r49_independent.get("primary_agreement") is not True
        or r8r49_independent.get("passed") is not False
        or r8r49_state.get("route") != r8r49_contract["required_route"]
        or r8r49_state.get("finished") is not True
        or r8r49_state.get("real_tsc_executed") is not False
        or int(r8r49_state.get("new_raw_count", -1)) != 0
        or len(r8r49_rows) != 256
        or len(selected_development_rows) != 208
        or any(row.get("passed") is not True for row in selected_development_rows)
        or len(excluded_development_rows) != 48
        or {row.get("candidate_id") for row in excluded_development_rows}
        != {"u0p50", "u0p75", "v0p50"}
        or any(row.get("passed") is not False for row in excluded_development_rows)
    ):
        raise SourceBlockedError("R8R51R1 final R8R49 route changed")
    ...
    selected = [row for row in candidates if row["id"] in SELECTED_CANDIDATE_IDS]
    selected_q = np.asarray([row["q"] for row in selected], dtype=float)
    selected_requested = selected_q @ matrix.T
    if (
        len(candidates) != 17
        or [row["id"] for row in selected] != list(SELECTED_CANDIDATE_IDS)
        or _matrix_digest(matrix) != ctx.cfg["matrix_contract"]["canonical_matrix_float64_le_c_sha256"]
        or _matrix_digest(selected_q) != ctx.cfg["matrix_contract"]["selected_q_float64_le_c_sha256"]
        or _matrix_digest(selected_requested) != ctx.cfg["matrix_contract"]["selected_requested_float64_le_c_sha256"]
        or int(np.linalg.matrix_rank(selected_q)) != 4
    ):
        raise SourceBlockedError("R8R51R1 R8R31 candidate matrix changed")
    ...
    return {
        "r8r51_hashes": r8r51_hashes,
        "r8r51_route": r8r51_contract["required_route"],
        "r8r51_raw_inventory_digest": r8r51_contract["raw_inventory_digest"],
        "r8r48_hashes": hashes,
        "r8r48_route": contract["required_route"],
        "r8r49_hashes": r8r49_hashes,
        "r8r49_route": r8r49_contract["required_route"],
        "r8r7": source_r8r7,
        "lineage": lineage,
...
def build_specs(ctx: Context) -> list[dict[str, Any]]:
    ...
    candidates = [
        row for row in r8r31._candidate_rows(source_cfg)
        if row["id"] in SELECTED_CANDIDATE_IDS
    ]
    ...
    for context_index, source in enumerate(baselines):
        for candidate in candidates:
            ...
            spec.update(
                {
                    "kind": "stage4_2r3c3t13s24d1r14r8r51r1_q0_transport_bridge",
                    "stage": STAGE,
                    "campaign_identity": IDENTITY,
                    "controller_revision": CONTROLLER_REVISION,
                    "experiment_id": f"r8r51r1_c{context_index:02d}_k{int(candidate['index']):02d}_{candidate['id']}",
                    "source_r8r7_baseline_experiment_id": str(source["experiment_id"]),
                    "r8r51r1_context_index": context_index,
                    "r8r51r1_candidate_index": int(candidate["index"]),
                    "r8r51r1_candidate_id": str(candidate["id"]),
                    "r8r51r1_candidate_q": q.tolist(),
                    "r8r51r1_requested_coordinate": requested.tolist(),
                    "r8r51r1_q0_issue_task_step": Q0_STEP,
                    "r8r51r1_candidate_issue_task_step": ISSUE_STEP,
                    "r8r51r1_first_effect_state_step": FIRST_EFFECT_STATE,
                    "r8r51r1_second_effect_state_step": SECOND_EFFECT_STATE,
                    "r8r51r1_return_task_step": RETURN_STEP,
                    "r8r51r1_allowed_in_expert_dataset": False,
            ...
            rows.append(spec)
    coverage = {
        (str(row["pair_id"]), str(row["history_member"]), int(row["r8r51r1_candidate_index"]))
        for row in rows
    }
    if len(rows) != 208 or len(coverage) != 208 or len({row["experiment_id"] for row in rows}) != 208:
        raise ValueError("R8R51R1 frozen specification matrix changed")
    return rows
...
def _payload(ctx: Context, spec: Mapping[str, Any]) -> dict[str, Any]:
    ...
    payload.update(
        {
            "variant_id": f"stage4_2r3c3t13s24d1r14r8r51r1_{experiment_id}",
            "stage4_2r3c3t13s24d1r14r8r51r1_candidate_id": str(spec["r8r51r1_candidate_id"]),
            "stage4_2r3c3t13s24d1r14r8r51r1_pair_history_label_available_to_controller": False,
        }
    )
...
Q0_BASE_CRITERIA_KEYS = frozenset(
    {
        "actuator_gate", "current_utilization", "exact_fields", "finite",
        "incremental_action", "no_current_clip", "no_saturation",
        "target_exact", "total_action",
    }
)
Q0_CRITERIA_KEYS = Q0_BASE_CRITERIA_KEYS | {"q0_integration_action"}
...
def _q0_event(
    *,
    ...
    """Build the one exact q0 event used by offline and real execution."""

    center = actuator.apply(currents, np.zeros(N_COILS, dtype=float))
    event = r8r22._refresh_event(
        task_step=task_step,
        currents=currents,
        target_fields=center.card15_fields,
        actuator=actuator,
        turns_tsc=actuator.turns_tsc,
        max_delta_a=actuator.max_slew_step_a,
        minimum_current=actuator.minimum_current_a_tsc,
    ...
    if set(event.get("criteria") or {}) != Q0_BASE_CRITERIA_KEYS:
        raise ValueError("R8R51R1 shared q0 base criterion keys changed")
    if "q0_zero_target" in event["criteria"]:
        raise ValueError("R8R51R1 forbidden q0_zero_target predicate present")
    event["event"] = "q0_exact_current_target_issue"
    event["q0_constructor_revision"] = "shared_exact_card15_current_target_v1"
    event["q0_center_card15_fields"] = list(center.card15_fields)
    event["criteria"]["q0_integration_action"] = bool(
        float(event["incremental_normalized_action_linf"])
        <= float(contract["maximum_q0_integration_action_linf"]) + 1e-12
    )
    if set(event["criteria"]) != Q0_CRITERIA_KEYS:
        raise ValueError("R8R51R1 shared q0 final criterion keys changed")
    event["passed"] = bool(all(event["criteria"].values()))
    return event
...
def _offline_construction(ctx: Context, specs: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    for spec in specs:
        ...
        issue = r8r22._construct_coordinate_issue(
            ...
            requested_coordinate=spec["r8r51r1_requested_coordinate"],
        ...
        criteria = {
            ...
            "candidate_identity": issue.get("candidate_id") == spec["r8r51r1_candidate_id"],
            "candidate_coordinate": bool(np.array_equal(
                np.asarray(issue.get("requested_coordinate"), dtype=float),
                np.asarray(spec["r8r51r1_requested_coordinate"], dtype=float),
            )),
        }
        rows.append(
            {
                ...
                "candidate_index": spec["r8r51r1_candidate_index"],
                "candidate_id": spec["r8r51r1_candidate_id"],
                "q0_event_digest": _digest(q0),
                "q0_action_norm_tsc": list(q0["action_norm_tsc"]),
                "q0_criteria_keys": sorted(q0["criteria"]),
                "q0_increment": q0["incremental_normalized_action_linf"],
    ...
    return {
        ...
        "maximum_q0_increment": max(float(row["q0_increment"]) for row in rows),
        ...
        "rows": rows,
        "passed": len(rows) == 208 and all(bool(row["passed"]) for row in rows),
    }
...
def prepare_offline(ctx: Context) -> dict[str, Any]:
    if ctx.paths.stage.exists():
        raise ValueError("R8R51R1 offline requires a fresh run identity")
    ...
    try:
        ...
        manifest = {
            ...
            "source_r8r51_run": str(ctx.r8r51_stage.parent),
            "source_r8r49_run": str(ctx.r8r49_stage.parent),
        ...
        report = {
            ...
            "maximum_q0_increment": construction["maximum_q0_increment"],
...
def _saved_specs(ctx: Context) -> list[dict[str, Any]]:
    ...
    if len(specs) != 208 or _digest(specs) != manifest.get("spec_digest") or _sha(ctx.config_path) != manifest.get("config_sha256"):
        raise ValueError("R8R51R1 saved specification identity changed")
    return specs
...
def authorize_real(ctx: Context) -> dict[str, Any]:
    ...
    if (
        ...
        raise ValueError("R8R51R1 offline independent authorization gate failed")
    _set_state(
        ctx,
...
class BridgeController(r6.d1r11.SequentialAmplitudeCodedProbeController):
    ...
    def __init__(self, base: Any, bundle: Mapping[str, Any], source_spec: Mapping[str, Any], initial_state: Mapping[str, Any], lattice_cfg: Mapping[str, Any], calibration_cfg: Mapping[str, Any], dynamic_cfg: Mapping[str, Any], schedule_cfg: Mapping[str, Any], controller_cfg: Mapping[str, Any], *, spec: Mapping[str, Any]):
        ...
        if matrix.shape != (4, 4):
            raise ValueError("R8R51R1 canonical matrix shape changed")
        self.r8r51r1_candidate_id = str(spec["r8r51r1_candidate_id"])
        self.r8r51r1_requested_coordinate = np.asarray(spec["r8r51r1_requested_coordinate"], dtype=float)
        self.r8r51r1_contract = copy.deepcopy(dict(controller_cfg))
        self.r8r51r1_center_fields: list[str] | None = None
        self.r8r51r1_center_current: list[float] | None = None
        self.r8r51r1_issue_event: dict[str, Any] | None = None
    ...
    def _q0(self, currents: np.ndarray) -> tuple[np.ndarray, dict[str, Any]]:
        ...
        event = _q0_event(
            ...
            lattice=self.lattice_cfg,
            contract=self.r8r51r1_contract,
        )
        if not event["passed"]:
            raise ValueError("R8R51R1 q0 action safety gate failed: " + json.dumps(event, sort_keys=True))
        self.r8r51r1_center_fields = list(event["q0_center_card15_fields"])
        self.r8r51r1_center_current = list(map(float, event["nominal_readback_current_a_tsc"]))
    ...
    def _issue_candidate(self, currents: np.ndarray) -> tuple[np.ndarray, dict[str, Any]]:
        ...
        event = r8r22._construct_coordinate_issue(
            ...
            fixed_basis_delta_field_kat_tsc=field_basis.T,
            requested_coordinate=self.r8r51r1_requested_coordinate,
            candidate_id=self.r8r51r1_candidate_id, actuator=self.actuator,
            controller_cfg=self.r8r51r1_contract, lattice_cfg=self.lattice_cfg,
        )
        event["center_nominal_readback_current_a_tsc"] = list(self.r8r51r1_center_current or [])
        if not event["passed"]:
            raise ValueError("R8R51R1 candidate action safety gate failed: " + json.dumps(event, sort_keys=True))
        self.r8r51r1_issue_event = copy.deepcopy(event)
        self._active_issue = copy.deepcopy(event)
        return np.asarray(event["action_norm_tsc"], dtype=float), event

    def _return(self, currents: np.ndarray) -> tuple[np.ndarray, dict[str, Any]]:
        if self.r8r51r1_center_fields is None or self.r8r51r1_issue_event is None:
            raise ValueError("R8R51R1 return has no causal stored center/issue")
        field_basis, _ = self._basis_current()
        event = _return_event(
            task_step=self.step, currents=currents,
            center_fields=self.r8r51r1_center_fields, issue_event=self.r8r51r1_issue_event,
            field_basis=field_basis, actuator=self.actuator, lattice=self.lattice_cfg,
            contract=self.r8r51r1_contract,
        )
        if not event["passed"]:
            raise ValueError("R8R51R1 return action safety gate failed: " + json.dumps(event, sort_keys=True))
        self._active_issue = None
        return np.asarray(event["action_norm_tsc"], dtype=float), event

    def _center_refresh(self, currents: np.ndarray) -> tuple[np.ndarray, dict[str, Any]]:
        if self.r8r51r1_center_fields is None:
            raise ValueError("R8R51R1 center refresh has no stored center")
        event = r8r22._refresh_event(
            task_step=self.step, currents=currents, target_fields=self.r8r51r1_center_fields,
        ...
        if not event["passed"]:
            raise ValueError("R8R51R1 refresh action safety gate failed: " + json.dumps(event, sort_keys=True))
        return np.asarray(event["action_norm_tsc"], dtype=float), event

    def action(self, current_state: Mapping[str, Any]) -> tuple[np.ndarray, dict[str, Any]]:
        if int(current_state["step_index"]) != self.step:
            raise ValueError("R8R51R1 controller/current state index mismatch")
        if self.step < PREFIX_END:
            ...
            if self.step == Q0_STEP:
                ...
                event = _observe_event(
                    task_step=self.step, currents=currents,
                    target_fields=self.r8r51r1_center_fields or [], actuator=self.actuator,
                    contract=self.r8r51r1_contract, event="q0_observe_hold",
                )
                ...
                if self.r8r51r1_issue_event is None:
                    raise ValueError("R8R51R1 candidate observation has no issue")
                event = _observe_event(
                    task_step=self.step, currents=currents,
        ...
        trace.update(
            {
                ...
                "r3c3t13s24d1r14r8r51r1_controller_revision": CONTROLLER_REVISION,
                "r3c3t13s24d1r14r8r51r1_delegated_prefix": delegated,
                "r3c3t13s24d1r14r8r51r1_event": event_name,
                "r3c3t13s24d1r14r8r51r1_event_detail": copy.deepcopy(event),
                "r3c3t13s24d1r14r8r51r1_forbidden_input_used": False,
                "r3c3t13s24d1r14r8r51r1_pair_or_history_label_used": False,
                "r3c3t13s24d1r14r8r51r1_future_measurement_used": False,
                "r3c3t13s24d1r14r8r51r1_future_action_used": False,
                "r3c3t13s24d1r14r8r51r1_source_result_used": False,
                "r3c3t13s24d1r14r8r51r1_hidden_wire_used": False,
            }
        )
    ...
    def evaluate(self, spec: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            if horizon != int(spec["formal_horizon_steps"]) or horizon != int(self.base.env.max_episode_steps) or horizon not in (35, 37):
                raise ValueError("R8R51R1 formal horizon changed")
            self.base.env.reset()
            ...
            for step in range(horizon):
                ...
                if not finite or bool(current.get("abnormal")):
                    ...
                    raise ValueError("R8R51R1 pre-action visible state safety gate failed")
                try:
                ...
                if truncated and step + 1 < horizon:
                    ...
                    raise RuntimeError("environment truncated before R8R51R1 horizon")
            names = [row.get("r3c3t13s24d1r14r8r51r1_event") for row in trace[PREFIX_END:]]
            event_pass = all(bool((row.get("r3c3t13s24d1r14r8r51r1_event_detail") or {}).get("passed")) for row in trace[PREFIX_END:])
            first_effect = bool(
            ...
            success = bool(
                ...
                and all(bool(row.get("r3c3t13s24d1r14r8r51r1_delegated_prefix")) for row in trace[:PREFIX_END])
            ...
            result.update(
                {
                    ...
                    "failure_reason": "" if success else "incomplete or invalid R8R51R1 rollout",
            ...
            if runner is not None:
                runner.cleanup_episode_workspace(failed=failed, reason="stage4_2r3c3t13s24d1r14r8r51r1")
...
def evaluate_specs(ctx: Context, specs: Sequence[dict[str, Any]], *, backend: str, resume: bool) -> dict[str, Any]:
    ...
    def args_for(spec: Mapping[str, Any], index: int) -> tuple[Any, ...]:
        return (payloads[str(spec["experiment_id"])], library, bundle, f"stage42r8r51r1_{index:03d}", selector, lattice, calibration, dynamic, schedule_cfg, controller_cfg)
    ...
    if backend == "serial":
        for index, spec in enumerate(pending):
            ...
            print(f"[R8R51R1] {index + 1}/{len(pending)}", flush=True)
        ...
        for start in range(0, len(pending), plan.actor_count):
            ...
            try:
                while refs:
                    ...
                    if not ready:
                        print(f"[R8R51R1] waiting {completed}/{len(pending)}", flush=True)
                        continue
                    ref = ready[0]
                    spec = refs.pop(ref)
                    try:
                    ...
                    r8r7.r8._write_gz(ctx.paths.raw / f"{spec['experiment_id']}.json.gz", result)
                    completed += 1
                    print(f"[R8R51R1] {completed}/{len(pending)}", flush=True)
            finally:
        ...
        raise ValueError(f"unsupported R8R51R1 backend: {backend}")
...
FORBIDDEN_KEYS = (
    "r3c3t13s24d1r14r8r51r1_forbidden_input_used",
    "r3c3t13s24d1r14r8r51r1_pair_or_history_label_used",
    "r3c3t13s24d1r14r8r51r1_future_measurement_used",
    "r3c3t13s24d1r14r8r51r1_future_action_used",
    "r3c3t13s24d1r14r8r51r1_source_result_used",
    "r3c3t13s24d1r14r8r51r1_hidden_wire_used",
)
...
def audit_raw(ctx: Context, *, write: bool = True) -> dict[str, Any]:
    ...
    for spec in specs:
        ...
        source_prefix_trace = bool(full and all(r8r22._source_trace_semantic_projection(reference, current) for current, reference in zip(trace[:PREFIX_END], source["controller_trace"][:PREFIX_END])))
        wrapper_prefixes = (
            "r3c3t13s24d1r14r4_", "r3c3t13s24d1r14r8r7_",
            "r3c3t13s24d1r14r8r51r1_",
        )
        ...
        events = [trace[step].get("r3c3t13s24d1r14r8r51r1_event_detail") or {} for step in range(PREFIX_END, horizon)] if full else []
        names = [trace[step].get("r3c3t13s24d1r14r8r51r1_event") for step in range(PREFIX_END, horizon)] if full else []
        ...
        expected_coordinate = matrix @ np.asarray(spec["r8r51r1_candidate_q"], dtype=float)
        candidate_exact = bool(
            issue.get("candidate_id") == spec["r8r51r1_candidate_id"]
            and np.array_equal(np.asarray(issue.get("requested_coordinate") or []), expected_coordinate)
            and np.array_equal(expected_coordinate, np.asarray(spec["r8r51r1_requested_coordinate"], dtype=float))
        )
        q0_exact = bool(
            ...
            and set(q0.get("criteria") or {}) == Q0_CRITERIA_KEYS
        ...
        offline_q0 = offline_rows.get(str(spec["experiment_id"]), {})
        q0_offline_parity = bool(
            q0_exact
            and _digest(q0) == offline_q0.get("q0_event_digest")
            and list(q0.get("action_norm_tsc") or []) == offline_q0.get("q0_action_norm_tsc")
            and sorted(q0.get("criteria") or {}) == offline_q0.get("q0_criteria_keys")
        )
        q0_first_effect = bool(
            ...
            and np.array_equal(
                np.asarray(trajectory[Q0_STEP]["action_norm_tsc"]),
                np.asarray(trace[Q0_STEP - 1]["action_norm_tsc"]),
            )
        )
        return_exact = bool(
        ...
        passed = bool(
            ...
            and candidate_exact and first_effect and finite_response and return_exact
    ...
    prefix_exact = {
        key: len(values) == 13 and len(set(values)) == 1 and bool(values[0])
    ...
    if passed_count == 208 and inventory["count"] == 208 and coverage == 208:
    ...
    report = {
        ...
        "raw_inventory": inventory, "expected_raw_count": 208,
        ...
        "source_trace_difference_wrapper_only_count": sum(bool(row["source_trace_difference_wrapper_only"]) for row in rows),
        ...
        "q0_first_effect_at_issue_plus_one_count": sum(bool(row["q0_first_effect_at_issue_plus_one"]) for row in rows),
...
def run_real(ctx: Context, *, backend: str, resume: bool) -> dict[str, Any]:
    ...
    if state.get("phase_status") != "real_authorized":
        raise ValueError("R8R51R1 real execution is not authorized")
    specs = _saved_specs(ctx)
    ...
    _set_state(
        ...
        response_outcomes_opened=bool(primary["finite_response_count"]),
        route=primary["route"],
...
def finalize_primary(ctx: Context) -> dict[str, Any]:
    ...
    if (
        ...
        raise ValueError("R8R51R1 raw independent gate incomplete")
    ...
    summary_keys = (
        ...
        "authentic_restart_count", "source_prefix_state_exact_count",
        "source_prefix_trace_exact_count", "source_trace_difference_wrapper_only_count",
        "causal_forbidden_pass_count", "q0_exact_count", "q0_offline_parity_count",
        "q0_first_effect_at_issue_plus_one_count",
...
def postprocess(ctx: Context) -> dict[str, Any]:
    ...
    if state.get("phase_status") != "final_primary_ready" or independent.get("passed") is not True or independent.get("primary_agreement") is not True:
        raise ValueError("R8R51R1 final independent agreement failed")
    compact = {
        "schema_version": 1, "stage": STAGE, "identity": IDENTITY,
        "source_r8r49_route": ctx.cfg["source_r8r49"]["required_route"],
    ...
    _set_state(
        ...
        new_raw_count=208, response_outcomes_opened=True,
...
def execute(ctx: Context, *, command: str, backend: str, resume: bool) -> dict[str, Any]:
    ...
    raise ValueError(f"unsupported R8R51R1 command: {command}")
...
def _parser() -> argparse.ArgumentParser:
    ...
    for name in (
        "r8r51-run", "r8r49-run", "r8r48-run", "r8r46-run", "r8r44-run", "r8r43-run", "r8r41-run",
