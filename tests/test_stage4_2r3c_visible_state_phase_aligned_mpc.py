...
class Stage42R3CDesignTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.config = json.loads(
            (
                cls.root
                / "configs"
                / "stage4_2r3c_visible_state_phase_aligned_mpc_370ms.json"
    ...
    def test_offline_command_cannot_start_real_control(self) -> None:
        state_path = Path("/synthetic/stage4_2r3c_state.json")
...
class Stage42R3CControllerInitializationTests(unittest.TestCase):
    def _controller(
        self,
        *,
        visible_phase: int,
        ...
        wire_value: float,
    ) -> tuple[r3c.PhaseAlignedTaskController, list[np.ndarray]]:
        ...
        with mock.patch.object(
            ...
            controller = r3c.PhaseAlignedTaskController(
                base, {}, spec, initial
            )
