...
PYTHON_BIN="${STAGE4_2R3C3T13S24D1R4_PYTHON:-/home/yangshen0711/tsc_all/tsc_simulation/venv_simu/bin/python}"
...
print("[T13S24D1R4 verify] Python/JSON/scientific guards passed.")
PY
...
printf '[T13S24D1R4 verify] checksums, inventory, shell syntax, compile, JSON and focused tests passed.\n'
