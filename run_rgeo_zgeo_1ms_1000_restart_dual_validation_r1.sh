...
cd "$ROOT"
: "${NR1000_DUAL_R1_SOURCE_REVISION:?set NR1000_DUAL_R1_SOURCE_REVISION}"
...
ARGS=(--config configs/rgeo_zgeo_1ms_1000_restart_dual_validation_r1.json
      --source-revision "$NR1000_DUAL_R1_SOURCE_REVISION" --output "$OUTPUT")
case "$MODE" in
