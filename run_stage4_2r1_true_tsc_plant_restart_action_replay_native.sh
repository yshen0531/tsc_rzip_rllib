...
printf '[Stage4.2R1 R1b] The lazy TSC runner is initialized before capture snapshot setup; finite structured failures and compatible successful snapshots remain resume-safe.\n'
