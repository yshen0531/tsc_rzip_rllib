...
printf '[Stage4.2R1 R1c] Lazy-runner capture setup and terminal full-wire telemetry remain lifecycle-safe; finite failures and compatible successful snapshots remain resume-safe.\n'
