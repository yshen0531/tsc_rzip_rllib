#!/usr/bin/env python3
"""Independent server-side authentication of the T13S5 blind holdout."""
...
def main() -> None:
    ...
    ctx = s4.load_stage42r3c3t13s5_config(
        args.config,
    ...
    for name, value in (
        ("stage4_2r3c3t13s5_raw_inventory.json", raw_inventory),
        ("stage4_2r3c3t13s5_run_inventory.json", run_inventory),
        ("stage4_2r3c3t13s5_snapshot_audit.json", snapshots),
        ("stage4_2r3c3t13s5_server_audit.json", audit),
    ):
        s4.t11.t1.r3c3.atomic_write_json(audit_dir / name, value)
    audit_path = audit_dir / "stage4_2r3c3t13s5_server_audit.json"
    print(json.dumps({
