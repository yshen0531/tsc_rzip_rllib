#!/usr/bin/env python3
"""Independent full-raw audit for ID2Z37."""
...
from scripts import rgeo_zgeo_1ms_id2z37_fresh_engineering_event_qualification as primary  # noqa: E402
...
SCHEMA = "rgeo-zgeo-1ms-id2z37-fresh-engineering-event-qualification-independent-v1"
...
def audit(config: Path, run_dir: Path, source_revision: str) -> dict[str, Any]:
    ...
    if (result.get("source_revision") != source_revision
            ...
            or result.get("id2z35_fit_rows") != 0
