#!/usr/bin/env python3
"""Independent offline and server-raw recomputation for frozen R8R49."""
...
from tsc_rzip_rllib.diagnostics import (
    stage4_2r3c3t13s24d1r14r8r49_q0_to_transport_causal_bridge_identification_sentinel
    as r49,
)
...
def _offline(ctx: r49.Context) -> dict[str, Any]:
    ...
    source_route = source.get("r8r48_route") == ctx.cfg["source_r8r48"]["required_route"]
...
def main() -> None:
    ...
    if args.command == "offline":
        ...
        raise ValueError("R8R49 independent command must be offline or run")
