#!/usr/bin/env python3
"""Independent Stage4.2R3c raw closed-loop control forensics.
...
def _timing_policy(
    ...
    return r3c.r1.r13._timing_policy(
        ...
        policy_id=(
            f"r42r3c_forensics_{spec['pair_id']}_"
...
def main() -> None:
    ...
    forensic = {
        ...
        "conclusion_guardrails": {
            ...
            "phase_selection_or_transition_design_failure": False,
        ...
        json.dumps(
            {
                ...
                "phase_counts": forensic["phase_alignment_diagnostic"][
