#!/usr/bin/env bash
set -euo pipefail
CONFIG=${1:-configs/mpo_b85c_conservative_recurrent_192worker_1m_probe.json}
RUN_NAME=${2:?run name required, e.g. train_b85c_conservative_recurrent_mpo_192worker_1m_probe_YYYYMMDD_HHMMSS}
STAGE=${3:-final}
